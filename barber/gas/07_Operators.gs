...
function saveOperator_(payload) {
  ...
  if (operatorId) {
    ...
    operator = updateRowById_('Operators', 'operator_id', operatorId, {
      ...
      work_start: payload.work_start || old.work_start || '',
      work_end: payload.work_end || old.work_end || '',
    ...
    operator = appendObject_('Operators', {
      ...
      work_start: payload.work_start || getSettingValue_('open_time', '08:00'),
      work_end: payload.work_end || getSettingValue_('close_time', '21:00'),
